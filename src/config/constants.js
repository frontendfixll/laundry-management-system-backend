...
// Platform roles for SuperAdmin model
...
// Maps notification types to which platform roles should receive them
const NOTIFICATION_ROLE_MAP = {
  // Orders - only superadmin
  [NOTIFICATION_TYPES.ORDER_PLACED]: [PLATFORM_ROLES.SUPER_ADMIN],

  // Tenancy signup - superadmin + sales
  [NOTIFICATION_TYPES.NEW_TENANCY_SIGNUP]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.SALES],

  // Subscription events - superadmin + finance + sales + auditor (for audit trail)
  [NOTIFICATION_TYPES.TENANCY_SUBSCRIPTION_UPDATED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.TENANCY_SUBSCRIPTION_EXPIRING]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES],
  [NOTIFICATION_TYPES.TENANCY_SUBSCRIPTION_EXPIRED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES],
  [NOTIFICATION_TYPES.SUBSCRIPTION_EXPIRING]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES],
  [NOTIFICATION_TYPES.PLAN_UPGRADED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.PLAN_DOWNGRADED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.SALES, PLATFORM_ROLES.AUDITOR],

  // Payment events - superadmin + finance + auditor
  [NOTIFICATION_TYPES.TENANCY_PAYMENT_RECEIVED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.PAYMENT_RECEIVED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE],
  [NOTIFICATION_TYPES.PAYMENT_FAILED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE],
  [NOTIFICATION_TYPES.REFUND_REQUEST]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.INVOICE_GENERATED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE, PLATFORM_ROLES.AUDITOR],

  // Lead events - superadmin + sales
  [NOTIFICATION_TYPES.NEW_LEAD]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.SALES],
  [NOTIFICATION_TYPES.LEAD_CONVERTED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.SALES, PLATFORM_ROLES.FINANCE],

  // Support events - superadmin + platform support
  [NOTIFICATION_TYPES.NEW_COMPLAINT]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.SUPPORT],
  [NOTIFICATION_TYPES.TICKET_ASSIGNED]: [PLATFORM_ROLES.SUPPORT],
  [NOTIFICATION_TYPES.TICKET_RESOLVED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.SUPPORT],

  // Security events - superadmin + auditor
  [NOTIFICATION_TYPES.SECURITY_ALERT]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.ACCOUNT_LOCKED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR, PLATFORM_ROLES.SUPPORT],
  [NOTIFICATION_TYPES.MULTIPLE_LOGIN_ATTEMPTS]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.PASSWORD_CHANGED]: [PLATFORM_ROLES.AUDITOR],

  // Permission/role events - superadmin + auditor
  [NOTIFICATION_TYPES.PERMISSION_GRANTED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.PERMISSION_REVOKED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR],
  [NOTIFICATION_TYPES.ROLE_UPDATED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.AUDITOR],

  // Usage/billing limits - superadmin + finance
  [NOTIFICATION_TYPES.USAGE_LIMIT_REACHED]: [PLATFORM_ROLES.SUPER_ADMIN, PLATFORM_ROLES.FINANCE],

  // Inventory - superadmin only
  [NOTIFICATION_TYPES.INVENTORY_REQUEST_SUBMITTED]: [PLATFORM_ROLES.SUPER_ADMIN],
};
